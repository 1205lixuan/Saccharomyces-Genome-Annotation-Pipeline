#!/usr/bin/perl
# diamond_cluster3.1.plx
use strict;
use warnings;



#  This script is used to cluster sequences based on the clean DIAMOND BLAST results.
...
my $fa = shift;
if (not $fa){
	die "usage: perl diamond_cluster3.1.plx <cpu_num> <coverage:0-100> <identity:0-100> <seq_type:prot or nucl> <fasta>\n";
}#if
if ($type ne "nucl" and $type ne "prot"){
	die "wrong type: $type\nusage: perl diamond_cluster3.1.plx <cpu_num> <coverage:0-100> <identity:0-100> <seq_type:prot or nucl> <fasta>\n";
}#if
